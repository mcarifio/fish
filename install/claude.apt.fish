...
set --local _flags_pkg $cmd-code
set --local _flags_key "https://downloads.claude.ai/keys/claude-code.asc"
set --local _flags_repo "https://downloads.claude.ai/claude-code/apt/stable"
